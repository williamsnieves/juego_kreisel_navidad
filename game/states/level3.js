...
var max = 0;
  ...
  Level3.prototype = {
    ...
    create: function() {
      ...
      /*this.addSmallTable(950,420,true,320,3000);

      this.addSmallTable(1250,420,true,250,5000);

      this.addSmallTable(1600,420,true,200,6000);*/

      this.addSmallTable(950,350);

      this.addSmallTable(1250,250);

      this.addSmallTable(1600,200);
      ...
      for(var i = 0; i < 4; i++){
        this.loadSmallCoins((i + 21) * 50,380);
      }      
    ...
    showInitText : function(){
      ...
      this.initText = this.game.add.text(this.game.world.x + 250,100,'¡Apresúrate!',{ font: 'bold 45px Ultra', fill: '#ff0000', stroke: '#ffffff', strokeThickness : 6 });
    ...
    removeCanvas : function(){
      //$("#plataform").hide();
      this.game.state.start('question3');
    },
