  ...
  Level4.prototype = {
    ...
    create: function() {
      ...
      this.addSmallTable(2700,260);*/
       ...
       this.addBigTable(720,150);
       this.addBigTable(2780,250,true,5000,350);

      this.addBigTableClean(2600,150,true,6000,400);
      ...
      for(var i = 0; i < 5; i++){
       ...
       for(var i = 0; i < 3; i++){
        this.loadSmallCoins((i + 22) * 50,300);
      }
      ...
      for(var i = 0; i < 5; i++){
        this.loadSmallCoins((i + 46) * 50,50);
      }
      ...
      for(var i = 0; i < 2; i++){
        this.loadSmallCoins((i + 53) * 50,380);
      }

      for(var i = 0; i < 4; i++){
        this.loadSmallCoins((i + 56) * 50,380);
      }
    ...
    update: function() {
      ...
      this.game.physics.arcade.collide(this.bigCoins, this.ground);
    ...
    showFinalScore : function(){
      ...
      this.scorefinalboard = this.scoreboardFinalGroup.create(this.game.width / 2, 300, 'scorefinal4');
    ...
    removeCanvas : function(){
      //$("#plataform").hide();
      this.game.state.start('question4');
    },
