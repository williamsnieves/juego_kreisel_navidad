  ...
  Level1.prototype = {
    ...
    create: function() {
      ...
      for(var i = 0; i < 6; i++){
        this.loadSmallCoins((i + 47) * 50,200);
      }
    ...
    updateCounter : function(){
      ...
      if(this.secMinTen){
        ...
        if(this.seconds == 0 && this.timeover){
    ...
    showInitText : function(){
      ...
      this.initText = this.game.add.text(this.game.world.x + 300,100,'¡Vamos!',{ font: 'bold 45px Ultra', fill: '#ff0000', stroke: '#ffffff', strokeThickness : 6 });
    ...
    addBigTable : function(x, y, tween){
      ...
      if(tween)
        this.game.add.tween(bigtable.position).to( { y: 100 }, 4000, Phaser.Easing.Back.InOut, true, 0, 2000, true);
    },
