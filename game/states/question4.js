...
Question4.prototype = {
  ...
  create: function() {
    ...
    this.instrucciones = this.game.add.sprite(50,160, 'question4bg')
    ...
    console.log(firstquest.questions[3].question.toString());*/
    this.timesText = this.game.add.text(80,330,firstquest.questions[3].question.toString().toUpperCase(),{ font: 'bold 28px Arial', fill: '#00422e'})
    this.firstquestion = this.game.add.text()
    this.btnplay2 = this.game.add.button(300, 530, 'btnlevel5', this.actionOnClick, this, 2, 1, 0);
    ...
    this.btnansleft1 = this.game.add.button(230,400, 'skewleft', this.firstAnswerlev4,this);
    ...
    this.btnansright1 = this.game.add.button(460,400, 'skewright', this.secondAnswerlev4,this);
    ...
    this.check.alpha = 1;
    localStorage.setItem("level4", firstquest.questions[3].level.toString());
    localStorage.setItem("question4", firstquest.questions[3].question.toString());
    localStorage.setItem("answer4", this.btnansleft1.name.toString());
  ...
  firstAnswerlev4:function(item){
    ...
    localStorage.setItem("level4", firstquest.questions[3].level.toString());
    localStorage.setItem("question4", firstquest.questions[3].question.toString());
    localStorage.setItem("answer4", item.name.toString());
  },
  secondAnswerlev4:function(item){
    this.coinBigHitSound.play();
    var firstquest = JSON.parse(localStorage.getItem("questions"));
